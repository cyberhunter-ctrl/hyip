...
namespace Illuminate\Support\Facades {
    ...
    class App
    {
        ...
        /**
         * Get the application's deferred modules.
         *
         * @return array
         * @static
         */
        ...
        /**
         * Set the application's deferred modules.
         *
        ...
        /**
         * Add an array of modules to the application's deferred modules.
         *
         * @param array $services
         * @return void
         * @static
    ...
    class Gate
    {
        ...
        {
            /** @var \RickSelby\Laravel\GateCache\GateCache $instance */
         ...
         * @return \Gate|\Illuminate\Contracts\Auth\Access\Gate|mixed
         * @static
         */
         ...
         * @return \RickSelby\Laravel\GateCache\GateCache
         * @throws \InvalidArgumentException
         * @static
         */
...
namespace App\Facades\Txn {
    ...
    class TxnFacade
    {
         ...
         * @param $method
         * @param $description
         * @param string|\App\Enums\TxnType $type
         * @param string|\App\Enums\TxnStatus $status
         ...
         * @static
         */
        public static function new($amount, $charge, $final_amount, $method, $description, $type, $status = App\Enums\TxnStatus::Pending, $payCurrency = null, $payAmount = null, $userID = null, $relatedUserID = null, $relatedModel = 'User', $manualFieldData = [], $approvalCause = 'none', $targetId = null, $targetType = null)
        {
            /** @var \App\Facades\Txn\Txn $instance */
            return $instance->new($amount, $charge, $final_amount, $method, $description, $type, $status, $payCurrency, $payAmount, $userID, $relatedUserID, $relatedModel, $manualFieldData, $approvalCause, $targetId, $targetType);
        }
         ...
         * @static
         */
        public static function update($tnx, $status, $userId = null, $approvalCause = 'ok')
        {
            /** @var \App\Facades\Txn\Txn $instance */
            return $instance->update($tnx, $status, $userId, $approvalCause);
        }
...
namespace Shakurov\Coinbase\Facades {
    ...
    class Coinbase
    {
         ...
         * @static
         */
        public static function makeRequest($method, $uri, $query = [], $params = [])
        {
            /** @var \Shakurov\Coinbase\Coinbase $instance */
            return $instance->makeRequest($method, $uri, $query, $params);
        }
...
namespace {
    ...
    class Txn extends \App\Facades\Txn\TxnFacade
    {
    }
    ...
    class PerfectMoney extends \charlesassets\LaravelPerfectMoney\PerfectMoney
    {
    }
