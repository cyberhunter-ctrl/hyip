                    ...
                    <table class="display data-table">
                        ...
                        @foreach($recentTransactions as $transaction )
                            <tr>
                                ...
                                <td><strong
                                        class="{{$transaction->type !== \App\Enums\TxnType::Subtract && $transaction->type !== \App\Enums\TxnType::Investment && $transaction->type !== \App\Enums\TxnType::SendMoney && $transaction->type !== \App\Enums\TxnType::Withdraw  ? 'green-color': 'red-color'}}">{{ ($transaction->type !== \App\Enums\TxnType::Subtract && $transaction->type !== \App\Enums\TxnType::Investment && $transaction->type !== \App\Enums\TxnType::SendMoney && $transaction->type !== \App\Enums\TxnType::Withdraw ? '+': '-' ).$transaction->amount.' '.$currency }}</strong>
                                </td>
