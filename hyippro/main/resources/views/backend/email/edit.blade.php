                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.email-template-update') }}" method="post"
                                ...
                                <div class="site-input-groups row">
                                    <label name="" class="col-sm-3 col-label">{{ __('Banner') }}<i icon-name="info"
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Salutation') }}<i icon-name="info"
                                                                                                      data-bs-toggle="tooltip"
                                                                                                      title=""
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Button') }}<i icon-name="info"
                                                                                                  data-bs-toggle="tooltip"
                                                                                                  title=""
